namespace config {
    ...
    export const PIN_LED_R = DAL.PA04;
    export const PIN_LED_G = DAL.PA08;
    export const PIN_LED_B = DAL.PA09;
    ...
    export const PIN_RXLED = DAL.PA04;
    export const PIN_TXLED = DAL.PA08; 
}
