namespace config {
    ...
    export const PIN_LED_RED = DAL.PA04;
    export const PIN_LED_GREEN = DAL.PA08;
    export const PIN_LED_BLUE = DAL.PA09;
    ...
    export const PIN_RXLED = DAL.PA08;
    export const PIN_TXLED = DAL.PA04; 
}
