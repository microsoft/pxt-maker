...
namespace config {
    ...
    export const PIN_D1 = DAL.PA07;
    export const PIN_D2 = DAL.PA06;
    export const PIN_D3 = DAL.PA05;
    export const PIN_D4 = DAL.PB08;
    export const PIN_D5 = DAL.PB09;
    export const PIN_D6 = DAL.PA04;
    export const PIN_D7 = DAL.PB03;
